  ...
  modal.innerHTML = `
    <div style="background:#fff;max-width:800px;width:95%;padding:20px;border-radius:12px;max-height:90vh;overflow:auto;">
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;">
        ...
        <button id="recipeClose" style="padding:8px 16px;border-radius:8px;border:1px solid #ddd;cursor:pointer;background:#f0f0f0;color:#333;font-size:16px;">× 閉じる</button>
      </div>
  ...
  const template = `
    <div style="background:#fff;max-width:620px;width:92%;padding:16px;border-radius:12px;box-sizing:border-box;max-height:85vh;overflow:auto;">
      <div style="display:flex;gap:8px;justify-content:flex-end">
        <button id="recipeClose" style="padding:8px 16px;border-radius:8px;border:1px solid #ddd;cursor:pointer;background:#f0f0f0;color:#333;">× 閉じる</button>
      </div>
