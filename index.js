...
// 主食トークンを拾う（部分一致）: 例 "チキンカレーライス" → "ライス"
...
// メニュー全体から最低限の買い物リストを復元（料理名は入れない）
